...
open class PlacesNearby: JSONEncodable, Mappable, Codable {

/** Coding keys for Codable protocol */
    enum CodingKeys: CodingKey {
        case pagination, links, disruptions, notes, feedPublishers, context, error, placesNearby, unknown
    }
    ...
    required public init(from decoder: Decoder) throws {
        ...
        placesNearby = try container.decode([PlaceNearby].self, forKey: .placesNearby)
    }
    ...
    public func mapping(map: Map) {
        ...
        context <- map["context"]
        error <- map["error"]
        placesNearby <- map["places_nearby"]
    }
    ...
    open func encodeToJSON() -> Any {
        ...
        nillableDictionary["places_nearby"] = self.placesNearby?.encodeToJSON()
