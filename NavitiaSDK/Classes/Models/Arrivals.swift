...
open class Arrivals: JSONEncodable, Mappable, Codable {

/** Coding keys for Codable protocol */
    enum CodingKeys: CodingKey {
        case pagination, links, disruptions, notes, arrivals, feedPublishers, context, error, exceptions, unknown
    }
    ...
    required public init(from decoder: Decoder) throws {
        ...
        arrivals = try container.decode([Passage].self, forKey: .arrivals)
