...
public struct PoiTypes: Codable {
    ...
    public init(pagination: Pagination, links: [LinkSchema]?, disruptions: [Disruption], notes: [Note]?, feedPublishers: [FeedPublisher], context: Context?, error: ModelError?, poiTypes: [PoiType]?) {
