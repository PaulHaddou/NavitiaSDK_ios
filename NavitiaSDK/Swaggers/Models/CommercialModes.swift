...
public struct CommercialModes: Codable {
    ...
    public init(pagination: Pagination, commercialModes: [CommercialMode]?, links: [LinkSchema]?, disruptions: [Disruption], notes: [Note]?, feedPublishers: [FeedPublisher], context: Context?, error: ModelError?) {
