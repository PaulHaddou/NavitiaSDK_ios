...
// MARK: - Data Model
//
public struct EndpointResponsePlaces: CreatableFromJSON { // TODO: Rename this struct
    let links: [Any?]
    let places: [Places]
    let warnings: [Warnings]
    init(links: [Any?], places: [Places], warnings: [Warnings]) {
        self.links = links
        self.places = places
    ...
    public init?(json: [String: Any]) {
        ...
        guard let warnings = Warnings.createRequiredInstances(from: json, arrayKey: "warnings") else { return nil }
    ...
    struct Places: CreatableFromJSON { // TODO: Rename this struct
        ...
        struct AdministrativeRegion: CreatableFromJSON { // TODO: Rename this struct
            ...
            let name: String
            let zipCode: String
            init(administrativeRegions: [Any?], coord: Coord, id: String, insee: String, label: String, level: Int, name: String, zipCode: String) {
            ...
            init?(json: [String: Any]) {
                guard let administrativeRegions = json["administrative_regions"] as? [Any?] else { return nil }
                ...
                self.init(administrativeRegions: administrativeRegions, coord: coord, id: id, insee: insee, label: label, level: level, name: name, zipCode: zipCode)
            }
    ...
    struct Warnings: CreatableFromJSON { // TODO: Rename this struct
        let id: String
        let message: String
