...
*/
    ...
    requestBuilder.withLat(48.8459388)
    requestBuilder.withLon(2.3709227)
    requestBuilder.withId("journey_pattern_point:476")
    ...
    let expectation = self.expectation(description: "CoverageLonLatUriJourneyPatternPointsIdRequestBuilder_get")
    let requestBuilder:CoverageLonLatUriJourneyPatternPointsIdRequestBuilder = JourneyPatternPointsApi(token: testToken).newCoverageLonLatUriJourneyPatternPointsIdRequestBuilder()
    ...
    waitForExpectations(timeout: 30)
    XCTAssertTrue(asyncResult!.journeyPatternPoints!.count > 0, "CoverageLonLatUriJourneyPatternPointsIdRequestBuilder_get : size")
    XCTAssertTrue(asyncResult!.journeyPatternPoints!.first != nil, "CoverageLonLatUriJourneyPatternPointsIdRequestBuilder_get : first element")
}
    ...
    let expectation = self.expectation(description: "CoverageRegionUriJourneyPatternPointsIdRequestBuilder_get")
    let requestBuilder:CoverageRegionUriJourneyPatternPointsIdRequestBuilder = JourneyPatternPointsApi(token: testToken).newCoverageRegionUriJourneyPatternPointsIdRequestBuilder()
    ...
    waitForExpectations(timeout: 30)
    XCTAssertTrue(asyncResult!.journeyPatternPoints!.count > 0, "CoverageRegionUriJourneyPatternPointsIdRequestBuilder_get : size")
    XCTAssertTrue(asyncResult!.journeyPatternPoints!.first != nil, "CoverageRegionUriJourneyPatternPointsIdRequestBuilder_get : first element")
}
