...
*/
    ...
    requestBuilder.withLat(48.8459388)
    requestBuilder.withLon(2.3709227)
    requestBuilder.withId("journey_pattern:41")
    ...
    let expectation = self.expectation(description: "CoverageLonLatUriJourneyPatternsIdRequestBuilder_get")
    let requestBuilder:CoverageLonLatUriJourneyPatternsIdRequestBuilder = JourneyPatternsApi(token: testToken).newCoverageLonLatUriJourneyPatternsIdRequestBuilder()
    ...
    waitForExpectations(timeout: 30)
    XCTAssertTrue(asyncResult!.journeyPatterns!.count > 0, "CoverageLonLatUriJourneyPatternsIdRequestBuilder_get : size")
    XCTAssertTrue(asyncResult!.journeyPatterns!.first != nil, "CoverageLonLatUriJourneyPatternsIdRequestBuilder_get : first element")
}
    ...
    let expectation = self.expectation(description: "CoverageRegionUriJourneyPatternsIdRequestBuilder_get")
    let requestBuilder:CoverageRegionUriJourneyPatternsIdRequestBuilder = JourneyPatternsApi(token: testToken).newCoverageRegionUriJourneyPatternsIdRequestBuilder()
    ...
    waitForExpectations(timeout: 30)
    XCTAssertTrue(asyncResult!.journeyPatterns!.count > 0, "CoverageRegionUriJourneyPatternsIdRequestBuilder_get : size")
    XCTAssertTrue(asyncResult!.journeyPatterns!.first != nil, "CoverageRegionUriJourneyPatternsIdRequestBuilder_get : first element")
}
